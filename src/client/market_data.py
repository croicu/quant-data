...
class MarketData:
    ...
    tasks/postgres_client_and_dimensions.md) -- but a narrower surface is still better ergonomics
    than handing consumers the full read/write PostgresDatabase ingest itself uses.
    """
